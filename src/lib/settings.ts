...
export const SETTING_DEFS: SettingDef[] = [
  ...
  },
  {
    ...
    help: "Habilita o botão \"Entrar com Google\" no login. Crie um OAuth Client (tipo Web) e cadastre a redirect URI /api/auth/google/callback.",
  ...
  },
  {
    ...
    help: "Habilita o botão \"Entrar com X\". Crie um app OAuth 2.0 e cadastre a redirect URI /api/auth/twitter/callback.",
